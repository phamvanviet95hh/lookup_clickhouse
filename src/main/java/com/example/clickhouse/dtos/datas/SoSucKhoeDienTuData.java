...
@NoArgsConstructor
@Builder
public class SoSucKhoeDienTuData {
    ...
    private List<MedicineDatas> thuoc;
    private List<DvKyThuatVatTus> dv_ky_thuat_vat_tu;
    private List<DvCanLamSangs> dv_can_lam_sang;
    private List<TtHoSoBenhAn> tt_ho_so_benh_an;
